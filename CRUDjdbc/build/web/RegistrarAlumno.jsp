<%-- 
    ...
    Created on : 13/02/2019, 03:32:38 PM
    Author     : juani
--%>
...
<html>
    ...
    <body>
        ...
        <div class="inputs">
            <form action="Registrar" id="center" >
                ...
                Grado <input type="text" placeholder="Gado" id="txtGrado" name="txtGrado"><br>
                Grupo <input type="text" placeholder="Grupo" id="txtGrupo" name="txtGrupo"><br>
